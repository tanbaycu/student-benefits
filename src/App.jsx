...
const BENEFITS_DATA = [
  ...
  {
    id: "b167",
    title: "Vietnam Railways (VNR) Student Discount",
    category: "Travel & Transport",
    value: "Giảm 10% giá vé tàu hỏa",
    description: "Giảm giá 10% trên tất cả các loại ghế ngồi và giường nằm của tất cả các đoàn tàu khách quanh năm cho sinh viên.",
    scope: "Vietnam",
    location: "Việt Nam",
    lifetime: false,
    updatedAt: "Vừa xong",
    savings: 15,
    link: "https://dsvn.vn",
    requirements: "Xuất trình thẻ sinh viên kèm CCCD tại ga hoặc nhập thông tin thẻ sinh viên khi đặt vé trực tuyến."
  },
  {
    id: "b168",
  ...
  },
  {
    ...
    title: "Eurail Youth Pass",
    category: "Travel & Transport",
    value: "Giảm giá tới 25% vé tàu hỏa liên quốc gia",
    description: "Thẻ đi tàu không giới hạn kết nối 33 quốc gia tại Châu Âu dành cho giới trẻ và học sinh khám phá du học.",
    scope: "Global",
    location: "Toàn cầu / Online",
    lifetime: false,
    updatedAt: "Vừa xong",
    savings: 100,
    link: "https://www.eurail.com",
    requirements: "Xác minh độ tuổi từ 12 - 27 bằng hộ chiếu khi mua vé và xuất trình khi lên tàu."
  },
  {
    id: "b224",
  ...
  },
  {
    ...
    description: "Phần mềm quản lý, sao lưu dữ liệu thiết bị iPhone/iPad trên máy tính tốt nhất hiện nay thay thế iTunes.",
    scope: "Global",
    location: "Toàn cầu / Online",
    lifetime: false,
    updatedAt: "Vừa xong",
